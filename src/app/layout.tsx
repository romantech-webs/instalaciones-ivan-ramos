  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="instalaciones-ivan-ramos";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Instalaciones Iván Ramos"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="instalaciones-ivan-ramos"
          data-primary-color="#fb0e03"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="instalaciones-ivan-ramos";
